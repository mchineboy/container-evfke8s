...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-evfke8s.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-evfke8s.containers.anotherwebservice.com/
...
```
git clone git@github.com:mchineboy/container-evfke8s.git
cd container-evfke8s
```
...
```
docker attach container-evfke8s
```
